...
其中，分母和分子的构成方式相同：基数词 \bil{ubu}{份} / \bil{fuwen}{分}，但同一个分数中不能混用。以下抖表示五分之三：
...
\begin{center}
    纪念（年号 / \bil{wargi suqungga}{公元}）+ 序数词 + aniya + 基数词 + biya (+ 基数词 inenggi / de)
\end{center}
...
\begin{itemize}
    \item batu jai tondo, we \aux{ele} \bil{den}{高}? batu \aux{ele} den.
\end{itemize}
